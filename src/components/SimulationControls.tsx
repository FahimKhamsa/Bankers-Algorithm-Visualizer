  ...
  return (
    <div className="flex flex-wrap items-center gap-4 p-4 bg-dark-card rounded-lg">
      <button
        onClick={onToggleRun}
        disabled={isComplete}
        className={`btn ${isRunning ? 'btn-danger' : 'btn-primary'} flex items-center ${isComplete ? 'opacity-50 cursor-not-allowed' : ''}`}
      >
        {isRunning ? (
          <>
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={`btn btn-secondary flex items-center ${(isRunning || currentStep === 0) ? 'opacity-50 cursor-not-allowed' : ''}`}
        >
        ...
        <button
          ...
          className={`btn btn-secondary flex items-center ${(isRunning || isComplete) ? 'opacity-50 cursor-not-allowed' : ''}`}
        >
